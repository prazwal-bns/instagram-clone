<div class="flex flex-col h-full overflow-hidden transition-all">
    ...
    <main class="relative h-full overflow-hidden overflow-y-scroll grow" style="contain:content">
        ...
        <ul class="grid w-full p-2 spacey-y-2">
            ...
            {{-- Chat list item --}}
            <li class="relative flex w-full gap-4 px-2 py-3 transition-colors duration-150 cursor-pointer hover:bg-gray-50 rounded-2xl dark:hover:bg-gray-200/70">

                <a href="#" class="shrink-0">
                    <x-avatar wire:ignore  src="https://randomuser.me/api/portraits/men/{{ rand(0, 99) }}.jpg"  class="w-12 h-12" />
                </a>

                <aside class="grid w-full grid-cols-12">


                    <a href="#" class="relative w-full col-span-10 p-1 pb-2 overflow-hidden leading-5 truncate border-b border-gray-200 flex-nowrap">
                        ...
                        <div class="flex items-center gap-x-2">
                            ...
                            <span class="text-xs font-bold">
                             ...
                             <span class="px-1 text-xs font-medium text-gray-800 shrink-0 ">5m</span>
                    ...
                    <div class="flex flex-col col-span-2 my-auto text-center">
