<div class="my-5 lg:px-8">
    <ul class="grid grid-cols-3 sm:gap-3 ">
        ...
        <li onclick="Livewire.dispatch('openModal',{ component: 'post.view.modal', arguments:{'post':{{$post->id}}}})"
            class="relative flex items-center justify-center w-full bg-black border rounded cursor-pointer h-28 sm:h-80 cursor group ">

            {{-- Hover comments and likes--}}
            <div
                class="absolute inset-x-0 z-10 items-center hidden gap-2 m-auto transition-all group-hover:flex max-w-fit">
            ...
            <div class="absolute z-10 text-white top-4 right-4">
                <span>
                    {{-- Download icon from https://iconduck.com/search?query=copy+rounded --}}
                    <svg class="w-6 h-6" height="32" viewBox="0 0 32 32" width="32" xmlns="http://www.w3.org/2000/svg">
