<div class="grid w-full h-full gap-3 overflow-hidden lg:grid-cols-12">
    ...
    <aside class="relative flex flex-col h-full gap-4 overflow-hidden overflow-y-scroll lg:col-span-5 scrollbar-hide">
        ...
        <header class="sticky top-0 z-10 flex items-center gap-3 py-2 bg-white border-b ">
            ...
            <x-avatar story src="https://randomuser.me/api/portraits/men/{{ rand(0, 99) }}.jpg" class="h-9 w-9" />
                    ...
                    <div class="grid w-full grid-cols-7 gap-2">
                        ...
                        <div class="flex flex-wrap col-span-6 text-sm ">
                            <p>
                                ...
                                <span class="text-sm font-bold">{{$post->user->name}} </span>
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. P neque ducimus blanditiis
                                nihil voluptatum, ve
                            </p>
        ...
        <footer class="sticky bottom-0 z-10 mt-auto bg-white border-t">
            ...
            {{-- view post modal --}}
            <button class="text-sm font-medium text-slate-500/90"> {{ $post->comments->count() }} comments
            </button>
