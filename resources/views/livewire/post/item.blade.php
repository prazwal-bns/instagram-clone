<div class="max-w-xl mx-auto">
    ...
    <footer>
        ...
        <div class=" flex text-sm gap-2 font-medium ">
            <p> <strong class="font-bold">John Surprise</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem dolore adipisci quibusdam qui aut nostrum omnis blanditiis maiores nesciunt. Omnis perferendis culpa in excepturi nemo ratione ea assumenda aspernatur voluptate!</p>
        </div>
        ...
        <form class="grid grid-cols-12 items-center w-full  "x-data="{ inputText: '' }">
            @csrf
            <input placeholder="Leave a comment" type="text" class="border-0 col-span-10 placeholder:text-sm text-sm outline-none w-full focus:outline-none px-0 rounded-lg hover:ring-0 focus:ring-0" x-model="inputText">
          
            <div class="col-span-1 ml-auto flex justify-end text-right  ">
                <button x-cloak class="text-sm font-semibold flex justify-end text-blue-500" x-show="inputText.length > 0">Post</button>
