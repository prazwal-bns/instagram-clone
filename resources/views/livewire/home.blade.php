...
" class="w-full h-full">
    ...
    {{-- <main class="grid gap-8 lg:grid-cols-12 md:mt-10"> --}}
            ...
            <aside class="hidden p-4 lg:col-span-4 lg:block">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <h4 class="flex font-medium intems-center ">{{ auth()->user()->name }}
                            ...
                            <span class="pl-2 text-blue-500">
                                <svg aria-label="Verified" class="x1lliihq x1n2onr6" fill="rgb(0, 149, 246)" height="20"
                                    role="img" viewBox="0 0 40 40" width="20">
                            ...
                            <div class="grid w-full grid-cols-7 gap-2">
                                ...
                                <div class="flex justify-end col-span-2 text-right">
                                    ...
                                    <button wire:click="toggleFollow({{ $user->id }})"
                                        class="ml-auto text-sm font-bold text-gray-500">Following</button>
                                    @else
                                    <button wire:click="toggleFollow({{ $user->id }})"
                                        class="ml-auto text-sm font-bold text-blue-500">Follow</button>
                                    @endif
                ...
                <section class="mt-5">
                    <ol class="flex flex-wrap gap-2">
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">About</a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">Help</a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">Press</a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">API</a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">Jobs</a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">Privacy
                            </a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#" class="hover:underline">Terms</a>
                        </li>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#"
                                class="hover:underline">Locations</a>
                        <li class="text-xs font-medium text-gray-800/90"><a href="#"
                                class="hover:underline">Language</a>
                        </li>
        ...
        {{-- Story Creator Modal --}}
        <div x-data="{ open: false }" x-on:open-story-creator.window="open = true"
            x-on:close-story-creator.window="open = false" x-show="open" x-cloak
