<div x-data="{
    ...
    <ul class="space-y-4">
        ...
        <li><a wire:navigate href="/" class="flex items-center gap-5 hover:bg-gray-200">
        ...
        <li><div
            @click="showSearch=true;showNotification=false;drawer=true"
        ...
        <template x-if="showSearch">
            <div x-cloak class="h-full mt-6 w-120">
                ...
                <header class="sticky top-0 z-10 w-full py-2 bg-white">
                    ...
                    <h5 class="my-4 text-4xl font-bold">Search</h5>

                    {{-- Change type to search --}}
                    <input type="search" wire:model.live='query' placeholder="Search "
                        class="w-full bg-gray-100 border-0 rounded-lg outline-none focus:outline-none hover:ring-0 focus:ring-0 ">
                </header>
                        ...
                        <li>
                            <a href="{{route('profile.home',$user->username)}}"
                                ...
                                <div class="flex flex-col">
                                    <span class="flex items-center text-sm font-semibold">{{$user->username}}
                                        @if($user->is_verified)
                                        <span class="pl-2 text-blue-500">
                                            <svg aria-label="Verified" class="x1lliihq x1n2onr6" fill="rgb(0, 149, 246)" height="15" role="img" viewBox="0 0 40 40" width="15">
